...
import { addItemToCart, removeItemFromCart, increaseItemQuantity, decreaseItemQuantity } from './features/cartSlice';
            ...
            <ul>
              {cartItems.map(item => (
                <li key={item.id}>
                  ...
                  <Button variant="outline-success" size="sm" onClick={() => handleIncreaseQuantity(item)}>
                    +
                  </Button>
                  <Button variant="outline-warning" size="sm" onClick={() => handleDecreaseQuantity(item)}>
                    -
                  </Button>
                  <Button variant="outline-danger" size="sm" onClick={() => handleRemoveItem(item)}>
                    Remove
                  </Button>
                </li>
              ))}
